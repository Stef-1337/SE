...
public class CascadeSelectView {
    ...
    public void init() {
        ...
        group6.setSelectItems(new SelectItem[]{option61, option62, option63, option64, option65, option66, option67, option68, option69, option610, option611, option612,
                option613, option614, option615, option616, option617, option618});
        ...
        group7.setSelectItems(new SelectItem[]{option71, option72, option73, option74, option75, option76, option77, option78, option79, option710, option711, option712,
                option713, option714, option715});
        ...
        group9.setSelectItems(new SelectItem[]{option91, option92, option93, option94, option95, option96, option97, option98, option99, option910, option911, option912,
                option913, option914, option915, option916});
